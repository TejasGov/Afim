...
export default function BrutalButton({ children, color = "bg-[#ccff00]", textColor = "text-black", className = "", href, ...props }) {
  const Tag = href ? "a" : "button";
  return (
    <Tag href={href} className={`relative group inline-block ${className}`} {...props}>
